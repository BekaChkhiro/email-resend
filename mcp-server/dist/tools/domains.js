...
import { validateDomainListFilters, } from "../schemas/domains.js";
// ============================================================================
// domains_list Tool
// ============================================================================
/**
 ...
 */
async function domainsList(args) {
    // Validate input
...
registerTool({
    name: "domains_list",
    description: "List all email sending domains with optional filtering. Supports filtering by active status and warmup enabled status, plus search and pagination.",
    inputSchema: {
        type: "object",
        properties: {
            isActive: {
