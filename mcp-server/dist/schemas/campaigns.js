 ...
 */
import { z } from "zod";
import { PaginationSchema, SortOrderSchema, CampaignStatusSchema, } from "./common.js";
// ============================================================================
...
const TimezoneSchema = z
    ...
    message: "Invalid timezone format. Use IANA timezone (e.g., 'America/New_York', 'Europe/London', 'UTC')",
});
/**
...
export const CampaignScheduleSchema = z
    ...
    sendDays: SendDaysSchema.describe("Days of week to send (0=Sunday, 1=Monday, ..., 6=Saturday)"),
    ...
    if (data.sendStartHour !== undefined &&
...
export const CampaignCreateSchema = z
    ...
    emailFormat: EmailFormatSchema.default("html").describe("Email format: 'html' or 'plain_text'"),
    delaySeconds: DelaySecondsSchema.describe("Delay between sends in seconds (0-3600)"),
    ...
    timezone: TimezoneSchema.optional()
        ...
        .describe("IANA timezone for scheduling (e.g., 'America/New_York')"),
    // AI integration
    aiPrompt: AiPromptSchema.describe("AI prompt for generating personalized email content"),
    // Contact selection
    selectedContactIds: ContactIdsSchema.describe("Array of contact IDs to include in campaign"),
})
    .refine((data) => {
...
export const CampaignUpdateSchema = z
    ...
    emailFormat: EmailFormatSchema.optional().describe("New email format: 'html' or 'plain_text'"),
    delaySeconds: z
        .number()
        .int()
        .min(0)
    ...
    // Status update
    status: CampaignStatusSchema.optional().describe("New campaign status (draft, sending, paused, completed)"),
    // Schedule fields
...
export const CampaignListFiltersSchema = z
    ...
    // Email format filter
    emailFormat: EmailFormatSchema.optional().describe("Filter by email format"),
    // AI-generated filter
    hasAiPrompt: z
        .boolean()
        .optional()
 ...
 */
export function validateCampaignUpdate(input) {
 ...
 */
export function validateCampaignListFilters(input) {
 ...
 */
export function validateCampaignAddContacts(input) {
 ...
 */
export function validateCampaignStatsRequest(input) {
 ...
 */
export function validateCampaignGet(input) {
 ...
 */
export function validateCampaignDelete(input) {
