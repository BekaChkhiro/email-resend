 ...
 */
export function validateContactCreate(input: unknown): {
  success: boolean;
  data?: ContactCreate;
 ...
 */
export function validateContactUpdate(input: unknown): {
  success: boolean;
  data?: ContactUpdate;
  errors?: Record<string, string[]>;
} {
 ...
 */
export function validateContactListFilters(input: unknown): {
  success: boolean;
 ...
 */
export function validateContactBulkCreate(input: unknown): {
  success: boolean;
